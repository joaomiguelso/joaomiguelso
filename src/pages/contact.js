            ...
            <section id="contacts" className="section has-background-light">
                <div className="container">
                    <div class="columns">
                        ...
                        <div class="column">
                            <form name="contact-project" netlify netlify-honeypot="bot-field" data-netlify="true">
            ...
            <section id="contacts" className="section has-background-light">
                <div className="container">
                    <div class="columns">
                        ...
                        <div class="column">
                            <form name="contact-coffee" netlify netlify-honeypot="bot-field" data-netlify="true">
                                <input type="hidden" name="bot-field" />
                                <div class="field">
                                    <label class="label">Name</label>
